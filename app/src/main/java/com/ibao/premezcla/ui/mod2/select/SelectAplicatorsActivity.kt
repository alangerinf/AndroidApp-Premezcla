...
import com.ibao.premezcla.models.Fumigadora
import com.ibao.premezcla.models.Tancada
import com.ibao.premezcla.models.Tractor
...
class SelectAplicatorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        asa_tViewLote.text= "${TANCADA.codeLote}"
        asa_tViewOrden.text= "${TANCADA.codeOrden}"
        ...
        btnSave.setOnClickListener {
            ...
            TANCADA.idFumigadora= fumigadoraList[fumPos].id
    ...
    fun saveOk() {
        Toast.makeText(this@SelectAplicatorsActivity,"Guardado",Toast.LENGTH_SHORT).show()
