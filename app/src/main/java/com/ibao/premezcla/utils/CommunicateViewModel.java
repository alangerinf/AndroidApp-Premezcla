package com.ibao.premezcla.utils;
...
public class CommunicateViewModel extends AndroidViewModel {
    ...
    private void onMessageReceived(String message) {
        ...
        messages=new StringBuilder(value[2].trim()+""+value[3].trim());
        messagesData.postValue(messages.toString());
    }
    ...
    private void toast(@StringRes int messageResource) { Toast.makeText(getApplication(), messageResource, Toast.LENGTH_SHORT).show(); }
    ...
    public void setMessages(String messages) {
        this.messagesData.setValue(messages);
    }
}
