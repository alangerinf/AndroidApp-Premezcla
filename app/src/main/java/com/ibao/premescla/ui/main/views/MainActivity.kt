...
import com.ibao.premescla.ui.main.views.fragments.*
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private var myFragment: FragmentMainInterface? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ctx = this
        myFragment = AllFragment()
        supportFragmentManager.beginTransaction().replace(R.id.content_main, (myFragment as AllFragment)!!).commit()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean { // Handle navigation view item clicks here.
        ...
        when (id) {
            ...
            R.id.nav_pendientes -> {
                ...
                myFragment = PendienteFragment()
                supportFragmentManager.beginTransaction().replace(R.id.content_main, (myFragment as PendienteFragment)!!).commit()
            }
            R.id.nav_proceso -> {
                title = getString(R.string.tittle_process_orders)
                myFragment = OnProcessFragment()
                supportFragmentManager.beginTransaction().replace(R.id.content_main, (myFragment as OnProcessFragment)!!).commit()
            }
            R.id.nav_terminada -> {
                title = getString(R.string.tittle_finished_orders)
                myFragment = FinishedFragment()
                supportFragmentManager.beginTransaction().replace(R.id.content_main, (myFragment as FinishedFragment)!!).commit()
            }
            /*
            R.id.nav_download -> {
            }
